...
//        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        share_newspage.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
...
//        read_newspage.setOnMenuItemClickListener(omicl);
    ...
    private void showShare() {
        cn.sharesdk.onekeyshare.OnekeyShare oks = new OnekeyShare();
        //关闭sso授权
        ...
        oks.setText(current_news.news_Title);
        //分享网络图片，新浪微博分享网络图片需要通过审核后申请高级写入接口，否则请注释掉测试新浪微博
        oks.setImageUrl(current_news.news_URL);
